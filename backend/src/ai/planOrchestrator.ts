...
function buildFallbackPlan(symbol: string, snap: TechnicalSnapshot, regime: RegimeProfile | undefined): PlanJson {
  ...
  const basePlan: PlanJson = {
    ...
    position: { risk_fraction: 0.015, max_leverage: 10 },

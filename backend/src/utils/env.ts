...
export function getConfig(): Cfg {
  ...
  return {
    ...
    ARBITRAGE_POLL_INTERVAL_SEC: Number(e.ARBITRAGE_POLL_INTERVAL_SEC || "180"),
    ...
    QUALITY_VOLUME_RATIO_BASE: Number(e.QUALITY_VOLUME_RATIO_BASE || "0.6"),
    QUALITY_VOLUME_RATIO_FLOOR: Number(e.QUALITY_VOLUME_RATIO_FLOOR || "0.4"),

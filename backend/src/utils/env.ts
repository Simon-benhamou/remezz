export type Cfg = {
  ...
  DEFAULT_BUDGET_FRACTION: number;
  ...
  TARGET_NOTIONAL_BASE_RATIO: number;
  TARGET_NOTIONAL_CONF_BONUS: number;
  TARGET_NOTIONAL_MAX_RATIO: number;
  CONFIDENCE_RISK_FLOOR_MIN_SHARE: number;
  CONFIDENCE_RISK_FLOOR_MAX_SHARE: number;
  CONFIDENCE_RISK_BOOST_SHARE: number;
  CONFIDENCE_RISK_BOOST_THRESHOLD: number;
  EV_REWARD_MULTIPLIER: number;
  SMALL_BALANCE_RISK_THRESHOLD_USD: number;
  SMALL_BALANCE_RISK_THRESHOLD_PCT: number;
...
export function getConfig(): Cfg {
  ...
  return {
    ...
    DEFAULT_MAX_LEVERAGE: Number(e.DEFAULT_MAX_LEVERAGE || "12"),
    DEFAULT_BUDGET_FRACTION: Number(e.DEFAULT_BUDGET_FRACTION || "0.5"),
    DAILY_LOSS_LIMIT_PCT: Number(e.DAILY_LOSS_LIMIT_PCT || "5"),
    MIN_STOP_PCT: Number(e.MIN_STOP_PCT || "0.2"),
    MIN_TP_PCT: Number(e.MIN_TP_PCT || "1.2"),
    MIN_FIRST_R: Number(e.MIN_FIRST_R || "1.8"),
    TARGET_TP1_PCT: Number(e.TARGET_TP1_PCT || "1.8"),
    TARGET_TP2_PCT: Number(e.TARGET_TP2_PCT || "3"),
    TARGET_TP3_PCT: Number(e.TARGET_TP3_PCT || "5"),
    TARGET_TP1_MIN_PNL_USD: Number(e.TARGET_TP1_MIN_PNL_USD || "15"),
    TARGET_TP1_MIN_PNL_RATIO: Number(e.TARGET_TP1_MIN_PNL_RATIO || "0.03"),
    TARGET_NOTIONAL_BASE_RATIO: Number(e.TARGET_NOTIONAL_BASE_RATIO || "0.5"),
    TARGET_NOTIONAL_CONF_BONUS: Number(e.TARGET_NOTIONAL_CONF_BONUS || "2"),
    TARGET_NOTIONAL_MAX_RATIO: Number(e.TARGET_NOTIONAL_MAX_RATIO || "1.6"),
    CONFIDENCE_RISK_FLOOR_MIN_SHARE: Number(e.CONFIDENCE_RISK_FLOOR_MIN_SHARE || "0.35"),
    CONFIDENCE_RISK_FLOOR_MAX_SHARE: Number(e.CONFIDENCE_RISK_FLOOR_MAX_SHARE || "0.85"),
    CONFIDENCE_RISK_BOOST_SHARE: Number(e.CONFIDENCE_RISK_BOOST_SHARE || "0.45"),
    CONFIDENCE_RISK_BOOST_THRESHOLD: Number(e.CONFIDENCE_RISK_BOOST_THRESHOLD || "0.6"),
    EV_REWARD_MULTIPLIER: Number(e.EV_REWARD_MULTIPLIER || "1.15"),
    SMALL_BALANCE_RISK_THRESHOLD_USD: Number(e.SMALL_BALANCE_RISK_THRESHOLD_USD || "500"),
    SMALL_BALANCE_RISK_THRESHOLD_PCT: Number(e.SMALL_BALANCE_RISK_THRESHOLD_PCT || "50"),
    ...
    LEVERAGE_CAP_DEFAULT: Number(e.LEVERAGE_CAP_DEFAULT || "8"),
    LEVERAGE_CAP_MAJOR: Number(e.LEVERAGE_CAP_MAJOR || e.LEVERAGE_CAP_DEFAULT || "10"),
    LEVERAGE_CAP_ALT: Number(e.LEVERAGE_CAP_ALT || e.LEVERAGE_CAP_DEFAULT || "6"),
    LEVERAGE_CAP_MEME: Number(
      e.LEVERAGE_CAP_MEME
    ...
    CONSERVATIVE_MAX_TRADES_PER_DAY: Number(e.CONSERVATIVE_MAX_TRADES_PER_DAY || "14"),
    CONSERVATIVE_MAX_CONSECUTIVE_STOPS: Number(e.CONSERVATIVE_MAX_CONSECUTIVE_STOPS || "4"),
    ...
    REACTIVE_MAX_TRADES_PER_DAY: Number(e.REACTIVE_MAX_TRADES_PER_DAY || "18"),
    REACTIVE_MAX_CONSECUTIVE_STOPS: Number(e.REACTIVE_MAX_CONSECUTIVE_STOPS || "6"),
    ...
    AGGRESSIVE_MAX_TRADES_PER_DAY: Number(e.AGGRESSIVE_MAX_TRADES_PER_DAY || "25"),
    AGGRESSIVE_MAX_CONSECUTIVE_STOPS: Number(e.AGGRESSIVE_MAX_CONSECUTIVE_STOPS || "8"),
    ...
    PORTFOLIO_MAX_BUDGET_FRACTION: Number(e.PORTFOLIO_MAX_BUDGET_FRACTION || "0.6"),

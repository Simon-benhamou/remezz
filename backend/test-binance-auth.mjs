...
async function testBinanceAuth() {
  ...
  try {
    ...
    console.log(`API Key: ${decryptedApiKey.substring(0, 10)}...`);
    ...
    try {
      ...
      if (error.message.includes('IP')) {
        ...
        console.log('   Your server IP may not be whitelisted on Binance');
        console.log('   Current server might be using a different IP');
      }

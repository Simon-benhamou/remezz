#!/usr/bin/env node
/**
 * 📊 BACKTEST HIGH + MEDIUM VOLATILITY
 * 
 * L'analyse montre:
 * - HIGH volatility: 0.4% à 8.8% selon les mois (très rare)
 * - MEDIUM volatility: 18% à 54% selon les mois (plus fréquent)
 * - LOW volatility: 38% à 81% (trop calme pour trader)
 * 
 * Test: Autoriser HIGH et MEDIUM, mais avec des paramètres différents
 */
...
function simulateTrade(ind, futureCandles, side) {
  ...
  // Paramètres différents selon le régime
